...
(Background) Select next layer, Skip empty layer
"""
...
class BgNextLayerSE(lwsdk.ICommandSequence):
    def __init__(self, context):
        super(BgNextLayerSE, self).__init__()
...
ServerRecord = {lwsdk.CommandSequenceFactory("SK_BG_NextLayerSE", BgNextLayerSE): ServerTagInfo}
