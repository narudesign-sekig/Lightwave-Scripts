...
(Foreground) Select previous layer, Skip empty layer
"""
...
class FgPrevLayerSE(lwsdk.ICommandSequence):
    def __init__(self, context):
        super(FgPrevLayerSE, self).__init__()
...
ServerRecord = {lwsdk.CommandSequenceFactory("SK_FG_PrevLayerSE", FgPrevLayerSE): ServerTagInfo}
